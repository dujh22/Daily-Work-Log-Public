...
3. [τ²-Bench最新论文解读](https://zhuanlan.zhihu.com/p/49404759454)
   ...
   4. 核心贡献3：细粒度的任务评估机制
      1. 多种不同的评估方式可用于进行更精细化分析与错误归因![1770810190604](image/r2-bench/1770810190604.png)
...
原论文 PDF（r^2-Bench 中/英文版）为大文件,已移出仓库,存于云盘归档 `notes/r2-bench/` 目录:

- `r^2-Bench_zh.pdf`(33MB)
- `r^2-Bench_en.pdf`(1.2MB)
